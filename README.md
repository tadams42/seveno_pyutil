...
[![tests](https://github.com/tadams42/seveno_pyutil/actions/workflows/tests.yaml/badge.svg?branch=main)](https://github.com/tadams42/seveno_pyutil/actions/workflows/tests.yaml)
